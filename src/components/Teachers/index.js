export { default as SingleTeacherPage } from './SingleTeacherPage';
export { default as UpdateTeacherForm } from './UpdateTeacherForm';
...
export { default as AddExtraPeriodForm } from './AddExtraPeriodForm';